...
import developerAboutImg from "@/assets/images/developer-about-img.png";
...
export function About() {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen flex items-center justify-center border-t border-border/40 py-24 px-6 overflow-hidden bg-secondary/5"
    >
      ...
      <div className="container mx-auto px-6 relative z-10 w-full max-w-[80rem]">
        ...
        <div className="grid gap-12 md:grid-cols-[1fr_1.5fr] items-center">
            ...
            >
              ...
              {/* Unflattened 3D Cyber Plate Backdrop Plane Wrapper */}
              <div
              ...
              >
                ...
                <motion.div
                  ...
                  className="w-full h-full rounded-full border border-primary/25 dark:border-primary/15 bg-gradient-to-br from-primary/10 via-background/80 to-transparent shadow-[0_8px_32px_0_rgba(0,0,0,0.15)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.35)] relative overflow-hidden flex items-center justify-center"
                  style={{
              ...
              {/* Transparent developer portrait photo overlaid cleanly with smooth edge and bottom-fade enhancements */}
              <div
                className="absolute w-[102%] h-[102%] left-[-1%] top-[-1%] select-none"
                style={{
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      fill
                      priority
                      className="object-contain object-bottom filter drop-shadow-[0_8px_24px_rgba(0,0,0,0.15)] hover:scale-[1.03] transition-transform duration-500 transform-gpu"
          ...
          >
            ...
            <div className="relative p-6 sm:p-8 md:p-9 rounded-2xl border border-accent-foreground/15 bg-background/40 backdrop-blur-md shadow-2xl space-y-6">
              ...
              <div className="relative p-6 rounded-xl border border-border/50 bg-background/25">
