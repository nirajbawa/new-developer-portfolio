...
import developerHeroImg from "@/assets/images/developer-hero-img.png";
...
const AwsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props}>
    ...
    <path 
      ...
      className="fill-[#232F3E] dark:fill-white transition-colors duration-300"
    />
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden select-none z-0">
        ...
        <motion.div 
          ...
          className="absolute top-[18%] left-[-8%] sm:left-[-3%] md:left-[2%] lg:left-[4%] w-44 h-44 sm:w-56 sm:h-56 rounded-[30%_70%_70%_30%_/_40%_30%_70%_60%] border border-white/10 dark:border-white/5 bg-gradient-to-br from-white/10 to-white/0 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(0,0,0,0.15)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] opacity-80 dark:opacity-60 flex items-center justify-center -z-10"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[22%] right-[-8%] sm:right-[-3%] md:right-[2%] lg:right-[4%] w-48 h-48 sm:w-64 sm:h-64 rounded-[70%_30%_40%_60%_/_60%_60%_30%_40%] border border-white/10 dark:border-white/5 bg-gradient-to-tr from-white/10 to-white/0 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(0,0,0,0.15)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] opacity-80 dark:opacity-60 flex items-center justify-center -z-10"
        >
          {/* Internal neon ambient circuitry pattern overlay */}
      ...
      <div className="container mx-auto px-6 relative z-10 w-full max-w-[84rem]">
        ...
        <div className="grid gap-12 lg:gap-24 lg:grid-cols-3 items-center justify-center">
          ...
          >
            ...
            <div className="relative p-6 md:p-8 space-y-4 rounded-xl">
              
              {/* Sleek Neon Corner Brackets */}
              <div className="absolute top-0 left-0 w-5 h-5 border-t-2 border-l-2 border-accent-foreground/70" />
              <div className="absolute top-0 right-0 w-5 h-5 border-t-2 border-r-2 border-accent-foreground/70" />
              <div className="absolute bottom-0 left-0 w-5 h-5 border-b-2 border-l-2 border-accent-foreground/70" />
              <div className="absolute bottom-0 right-0 w-5 h-5 border-b-2 border-r-2 border-accent-foreground/70" />
              
              {/* Inner ambient glow */}
              <div className="absolute inset-0 bg-accent-foreground/[0.01] dark:bg-accent-foreground/[0.02] backdrop-blur-[2px] rounded-xl -z-10" />
          ...
          >
            ...
            <div className="relative p-6 md:p-8 space-y-4 rounded-xl">
              ...
              {/* Inner ambient glow */}
              <div className="absolute inset-0 bg-primary/[0.01] dark:bg-primary/[0.02] backdrop-blur-[2px] rounded-xl -z-10" />
            ...
            <div className="grid grid-cols-3 gap-3 pl-1 w-full">
              <a
                ...
                className={cn(
                  ...
                  "rounded-lg bg-accent-foreground text-primary text-[0.65rem] sm:text-xs font-bold font-mono shadow-lg shadow-accent-foreground/10 hover:opacity-90 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300 flex items-center justify-center h-11 border-none px-1 text-center"
                )}
              >
                View CV
              </a>
